...
const testimonials: Testimonial[] = [
  {
    ...
    image:
      "https://placehold.co/80x80/bae6fd/334155?text=WW",
  },
  {
    quote:
      '"The staff were incredibly professional and caring. Everything was explained clearly, and I felt comfortable throughout my entire visit."',
    name: "Sarah Johnson",
    role: "Patient Care Specialist",
    image:
      "https://placehold.co/80x80/dcfce7/334155?text=SJ",
  },
  {
    quote:
      '"Excellent service from the moment I arrived. The medical team was attentive, knowledgeable, and genuinely focused on my recovery."',
    name: "Michael Brown",
    role: "Hospital Patient",
    image:
      "https://placehold.co/80x80/e9d5ff/334155?text=MB",
  },
];
                  ...
                  <div className="mt-5 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-white/70 text-[#8580a5] transition-all cursor-pointer duration-200 hover:bg-white hover:text-[#7652b8]"
                      >
                        <ArrowLeft size={14} />
                      </button>
