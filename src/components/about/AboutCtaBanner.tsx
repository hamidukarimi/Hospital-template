...
export default function AboutCtaBanner({ about }: AboutCtaBannerProps) {
  const title = about?.ctaTitle || "Your Health. Our Priority.";
  const subtitle =
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 w-full md:w-auto">
            <Link
              to={buttonUrl}
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-teal-400 px-6 py-3 text-sm font-bold text-slate-950 transition-all hover:bg-teal-300 hover:shadow-lg hover:shadow-teal-400/20 active:scale-95"
            >
